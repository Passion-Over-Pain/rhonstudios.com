    ...
    return (
        ...
        >
            ...
            <svg 
                ...
                className="absolute top-8 left-8 w-50 h-50"
            >
                <motion.path
            ...
            <svg 
                ...
                fill="none" 
                xmlns="http://www.w3.org/2000/svg"
                className="absolute bottom-8 right-8 w-50 h-50"
            >
                <motion.path
                    initial={{ pathLength: 0 }}
                    whileInView={{ pathLength: 1 }}
            ...
            <div className="absolute top-8 left-1/2 -translate-x-1/2 -translate-y-1/2 mt-10">
                <div className="inline-block border-2 border-white/80 px-10 py-2 rounded-md bg-black/60 backdrop-blur-sm">
                    <p
                        className="text-xs tracking-[0.3em] uppercase text-white"
            ...
            >
                    <span
                        className="inline-block px-16 py-5 border-2 border-white text-sm tracking-[0.2em] uppercase bg-black hover:bg-white hover:text-black transition-all duration-300"
                        style={{ fontFamily: "Cinzel", fontWeight: 200 }}
                    >
                        {t.highlight.button}
                    </span>
